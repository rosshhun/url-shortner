          ...
          <div class="az-dashboard-nav">
            ...
            <nav class="nav">
              <a class="nav-link" href="#"
                ><i class="far fa-save"></i> Save Report</a
              >
              <a class="nav-link" href="#"
                ><i class="far fa-file-pdf"></i> Export to PDF</a
              >
              <a class="nav-link" href="#"
                ><i class="far fa-envelope"></i>Send to Email</a
              >
              ...
              <div class="card card-dashboard-one">
                <div class="card-header">
                  <div>
                    ...
                    <p class="card-text">
                      Audience to which the users belonged while on the current
                      date range.
                    </p>
                  </div>
                  <div class="btn-group">
                    ...
                    <div class="card-header">
                      ...
                      <h6>
                        ...
                        <small class="tx-success"
                          ><i class="icon ion-md-arrow-up"></i> 2.87%</small
                        >
                      </h6>
                      <small
          ...
          <div class="row row-sm mg-b-20 mg-lg-b-0">
                  ...
                  <div class="card card-dashboard-five">
                    <div class="card-header">
                      ...
                      <span class="card-text"
                        ...
                        search engines, social networks or website
                        referrals.</span
                      >
                    </div>
                    <!-- card-header -->
                ...
                <div class="col-md-6 col-lg-12">
                  <div class="card card-dashboard-five">
                    <div class="card-header">
                      ...
                      <span class="card-text">
                        A session is the period time a user is actively engaged
            ...
            <div class="col-lg-7 col-xl-8 mg-t-20 mg-lg-t-0">
              <div class="card card-table-one">
                ...
                <p class="az-content-text mg-b-20">
                  Part of this date range occurs before the new users metric had
                  been calculated, so the old users metric is displayed.
                </p>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <i
                            class="flag-icon flag-icon-gb flag-icon-squared"
                          ></i>
                        </td>
                      ...
                      <tr>
                        <td>
                          <i
                            class="flag-icon flag-icon-in flag-icon-squared"
                          ></i>
                        </td>
                      ...
                      <tr>
                        <td>
                          <i
                            class="flag-icon flag-icon-ca flag-icon-squared"
                          ></i>
                        </td>
                      ...
                      <tr>
                        <td>
                          <i
                            class="flag-icon flag-icon-fr flag-icon-squared"
                          ></i>
                        </td>
                      ...
                      <tr>
                        <td>
                          <i
                            class="flag-icon flag-icon-ph flag-icon-squared"
                          ></i>
                        </td>
